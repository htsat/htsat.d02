...
*****************************************************************************/
extern int pcie_dma_cur_status_get(u32 pcie_if, u32 channel, enum pcie_dma_channel_status_e *dma_channel_status);
...
*****************************************************************************/
extern int pcie_dma_int_enable(u32 pcie_if, u32 channel, enum pcie_dma_int_type_e int_type);
...
*****************************************************************************/
extern int pcie_dma_int_mask(u32 pcie_if, u32 channel, enum pcie_dma_int_type_e int_type);
...
*****************************************************************************/
extern int pcie_dma_tranfer_stop(u32 pcie_if, u32 channel);
...
*****************************************************************************/
extern int pcie_dma_int_status_get(u32 pcie_if, u32 channel, int *dma_int_status);
...
*****************************************************************************/
extern int pcie_dma_int_clear(u32 pcie_if, u32 channel, enum pcie_dma_int_type_e dma_int_type);
