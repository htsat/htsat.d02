 ...
 * @dsaf_id: dsa fabric id
 */
static void dsaf_sbm_cfg_mib_en(u32 dsaf_id)
{
	union dsaf_sbm_cfg_reg o_sbm_cfg;
	u32 i;
...
void dsaf_comm_init(u32 dsaf_id, enum dsaf_mode dsaf_mode)
{
	...
	(void)pr_debug("dsaf_comm_init R: \r\n");
...
void dsaf_inode_init(u32 dsaf_id)
{
	...
	(void)pr_debug("dsaf_init_hw dsaf_inode_in_port_num dsaf%d !\n", dsaf_id);
	...
	(void)pr_debug("dsaf_inode_pri_tc_cfg dsaf%d !\n", dsaf_id);
}
 ...
 * @dsaf_id: dsa fabric id
 */
void dsaf_sbm_init(u32 dsaf_id)
{
	u32 sram_init_over;
